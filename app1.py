...
- Columns: student_name (text), student_Id (int), student_course (text), course_fee(float).
...
A: SELECT COUNT(*) FROM Student_details

Q: Show all Data science students
A: SELECT * FROM Stuident_details WHERE student_course = 'Data science'
